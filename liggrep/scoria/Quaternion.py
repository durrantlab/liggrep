...
class Quaternion:
    ...
    def __init__(self, s, x, y, z):
        """Initializes the .Quaternion class.
    ...
    def add(self, q2):
        ...
        :param .Quaternion q2: A quaternion, to be added to self
    ...
    def minus(self, q2):
        ...
        :param .Quaternion q2: A quaternion, to be subtracted from self
    ...
    def multiply(self, q2):
        ...
        :param .Quaternion q2: A quaternion, to be multiplied with self
