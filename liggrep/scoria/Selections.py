...
class Selections():
    ...
    def select_atoms(self, selection_criteria):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.select_atoms`.
    ...
    def select_atoms_in_bounding_box(self, bounding_box):
        ...
        :meth:`~.Molecule.Molecule.select_atoms_in_bounding_box`.
    ...
    def select_all_atoms_bound_to_selection(self, selection):
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.select_all_atoms_bound_to_selection`.
    ...
    def select_branch(self, root_atom_index, directionality_atom_index):
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.select_branch`.
    ...
    def select_atoms_from_same_molecule(self, selection):
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.select_atoms_from_same_molecule`.
    ...
    def selections_of_constituent_molecules(self):
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.selections_of_constituent_molecules`.
        ...
        # If your .Molecule object contains multiple molecules (e.g.,
    ...
    def select_atoms_near_other_selection(self, selection, cutoff):
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.select_atoms_near_other_selection`.
    ...
    def select_atoms_in_same_residue(self, selection):
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.select_atoms_in_same_residue`.
    ...
    def invert_selection(self, selection):
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.invert_selection`.
    ...
    def select_all(self):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.select_all`.
    ...
    def select_close_atoms_from_different_molecules(self, other_mol, cutoff,
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.select_close_atoms_from_different_molecules`.
    ...
    def get_molecule_from_selection(self, selection, serial_reindex = True,
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.get_molecule_from_selection`.
    ...
    def selections_of_chains(self):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.selections_of_chains`.
    ...
    def selections_of_residues(self):
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.selections_of_residues`.
