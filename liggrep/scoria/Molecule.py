...
class Molecule:  # here's the actual Molecule class
    ...
    def get_coordinates(self, frame=None):
        ...
        Wrapper function for :meth:`~.Information.Information.get_coordinates`
    ...
    def get_trajectory_coordinates(self):
        ...
        Wrapper function for :meth:`~.Information.Information.get_trajectory_coordinates`
    ...
    def get_filename(self):
        ...
        Wrapper function for :meth:`~.Information.Information.get_filename`
    ...
    def get_remarks(self):
        ...
        Wrapper function for :meth:`~.Information.Information.get_remarks`
    ...
    def get_atom_information(self):
        ...
        Wrapper function for :meth:`~.Information.Information.get_atom_information`
    ...
    def get_coordinates_undo_point(self):
        ...
        Wrapper function for :meth:`~.Information.Information.get_coordinates_undo_point`
    ...
    def get_bonds(self):
        ...
        Wrapper function for :meth:`~.Information.Information.get_bonds`
    ...
    def get_hierarchy(self):
        ...
        Wrapper function for :meth:`~.Information.Information.get_hierarchy`
    ...
    def get_constants(self):
        ...
        Wrapper function for :meth:`~.Information.Information.get_constants`
    ...
    def get_center_of_mass(self, selection=None, frame=None):
        ...
        Wrapper function for :meth:`~.Information.Information.get_center_of_mass`

        :param numpy.array selection: The indices of
                          the atoms to consider when calculating the center of mass.
                          If ommitted, all atoms of the .Molecule object
                          will be considered.
    ...
    def get_geometric_center(self, selection=None, frame=None):
        ...
        Wrapper function for :meth:`~.Information.Information.get_geometric_center`
    ...
    def get_total_mass(self, selection=None):
        ...
        Wrapper function for :meth:`~.Information.Information.get_total_mass`
    ...
    def get_total_number_of_atoms(self, selection=None):
        ...
        :meth:`~.Information.Information.get_total_number_of_atoms`
        ...
        :param numpy.array selection: An optional numpy.array containing the indices of
                    ...
                    .Molecule object will be considered.
    ...
    def get_total_number_of_heavy_atoms(self, selection=None):
        ...
        Wrapper function for
        :meth:`~.Information.Information.get_total_number_of_heavy_atoms`
    ...
    def get_bounding_box(self, selection=None, padding=0.0, frame=None):
        ...
        Wrapper function for :meth:`~.Information.Information.get_bounding_box`
    ...
    def get_bounding_sphere(self, selection=None, padding=0.0, frame=None):
        ...
        Wrapper function for :meth:`~.Information.Information.get_bounding_sphere`
    ...
    def get_default_trajectory_frame(self):
        ...
        Wrapper function for :meth:`~.Information.Information.get_default_trajectory_frame`
    ...
    def set_filename(self, filename):
        ...
        Wrapper function for :meth:`~.Information.Information.set_filename`
    ...
    def set_remarks(self, remarks):
        ...
        Wrapper function for :meth:`~.Information.Information.set_remarks`
    ...
    def set_atom_information(self, atom_information):
        ...
        :meth:`~.Molecule.Molecule.get_atom_information` for
        information on the numpy.array structure.

        Wrapper function for :meth:`~.Information.Information.set_atom_information`
    ...
    def set_coordinates(self, coordinates, frame=None):
        ...
        Wrapper function for :meth:`~.Information.Information.set_coordinates`
    ...
    def set_trajectory_coordinates(self, trajectory):
        ...
        Wrapper function for :meth:`~.Information.Information.set_trajectory_coordinates`
    ...
    def set_coordinates_undo_point(self, coordinates_undo_point):
        ...
        Wrapper function for :meth:`~.Information.Information.set_coordinates_undo_point`
    ...
    def set_bonds(self, bonds):
        ...
        :meth:`~.Molecule.Molecule.get_bonds` for additional
        information.

        Wrapper function for :meth:`~.Information.Information.set_bonds`
    ...
    def set_hierarchy(self, hierarchy):
        ...
        Wrapper function for :meth:`~.Information.Information.set_hierarchy`
        """
    ...
    def set_default_trajectory_frame(self, frame):
        ...
        Wrapper function for :meth:`~.Information.Information.set_default_trajectory_frame`
    ...
    def assign_masses(self):
        """
        Assigns masses to the atoms of the .Molecule object.

        Wrapper function for :meth:`~.Information.Information.assign_masses`
    ...
    def assign_elements_from_atom_names(self, selection=None):
        ...
        Wrapper function for :meth:`~.Information.Information.assign_elements_from_atom_names`
    ...
    def define_molecule_chain_residue_spherical_boundaries(self):
        ...
        .Information.Information.hierarchy.

        Requires the :any:`numpy` and :any:`scipy<scipy.spatial>` libraries.

        Wrapper function for
        :meth:`~.Information.Information.define_molecule_chain_residue_spherical_boundaries`
        """
    ...
    def serial_reindex(self):
        ...
        Wrapper function for :meth:`~.Information.Information.serial_reindex`
        """
    ...
    def resseq_reindex(self):
        ...
        Wrapper function for :meth:`~.Information.Information.resseq_reindex`
        """
    ...
    def belongs_to_protein(self, atom_index):
        ...
        Wrapper function for :meth:`~.Information.Information.belongs_to_protein`
    ...
    def belongs_to_rna(self, atom_index):
        ...
        Wrapper function for :meth:`~.Information.Information.belongs_to_rna`
    ...
    def belongs_to_dna(self, atom_index):
        ...
        Wrapper function for :meth:`~.Information.Information.belongs_to_dna`
    ...
    def insert_trajectory_frame(self, index, coordinates):
        ...
        Wrapper function for :meth:`~.Information.Information.insert_trajectory_frame`
    ...
    def delete_trajectory_frame(self, index):
        ...
        Wrapper function for :meth:`~.Information.Information.delete_trajectory_frame`
    ...
    def get_trajectory_frame_count(self):
        ...
        Wrapper function for :meth:`~.Information.Information.get_trajectory_frame_count`
    ...
    def load_pym_into(self, filename):
        ...
        Wrapper function for :meth:`~.FileIO.FileIO.load_pym_into`
    ...
    def load_pdb_into(
        ...
        Wrapper function for :meth:`~.FileIO.FileIO.load_pdb_into`
        ...
        self.fileio.load_pdb_into(
            filename, bonds_by_distance, serial_reindex, resseq_reindex, is_trajectory
        )
    ...
    def load_pdb_into_using_file_object(
        ...
        the current .Molecule object. Note that most users will want
        ...
        Wrapper function for :meth:`~.FileIO.FileIO.load_pdb_into_using_file_object`
        ...
        self.fileio.load_pdb_into_using_file_object(
            file_obj, bonds_by_distance, serial_reindex, resseq_reindex, is_trajectory
        )
    ...
    def load_pdbqt_into_using_file_object(
        self,
        file_obj,
        bonds_by_distance=False,
        serial_reindex=True,
        ...
        into the current .Molecule object. Note that most users will
        ...
        Wrapper function for :meth:`~.FileIO.FileIO.load_pdbqt_into_using_file_object`
    ...
    def save_pym(
        ...
        """
        Saves the molecular data contained in a .Molecule object
        to a pym file.

        Requires the :any:`numpy` library.

        Wrapper function for :meth:`~.FileIO.FileIO.save_pym`
    ...
    def save_pdb(
        ...
        Wrapper function for :meth:`~.FileIO.FileIO.save_pdb`
    ...
    def load_pdbqt_trajectory_into(
        self,
        filename,
        bonds_by_distance=True,
        serial_reindex=True,
        ...
        AutoDock Vina output file) into the current .Molecule
        object.

        Should be called via the wrapper function :meth:`.Molecule.Molecule.load_pdbqt_trajectory_into`
        ...
        return self.fileio.load_pdbqt_trajectory_into(
            filename, bonds_by_distance, serial_reindex, resseq_reindex
        )

    def load_pdbqt_trajectory_into_using_file_object(
        self,
        file_obj,
        bonds_by_distance=True,
        serial_reindex=True,
        ...
        formatted) into the current .Molecule object. Note that most
        ...
        Wrapper function for
        :meth:`~.FileIO.FileIO.load_pdbqt_trajectory_into_using_file_object`
        ...
        return self.fileio.load_pdbqt_trajectory_into_using_file_object(
            file_obj, bonds_by_distance, serial_reindex, resseq_reindex
        )

    def load_pdb_trajectory_into(
        self,
        filename,
        bonds_by_distance=True,
        serial_reindex=True,
        ...
        current .Molecule object.

        Should be called via the wrapper function :meth:`.Molecule.Molecule.load_pdb_trajectory_into`
        ...
        return self.fileio.load_pdb_trajectory_into(
            filename, bonds_by_distance, serial_reindex, resseq_reindex
        )

    def load_pdb_trajectory_into_using_file_object(
        self,
        file_obj,
        bonds_by_distance=True,
        serial_reindex=True,
        ...
        Should be called via the wrapper function :meth:`.Molecule.Molecule.load_pdb_trajectory_into_using_file_object`
        ...
        return self.fileio.load_pdb_trajectory_into_using_file_object(
            file_obj, bonds_by_distance, serial_reindex, resseq_reindex
        )
    ...
    def load_MDAnalysis_into(self, *args):
        ...
        Wrapper function for
        :meth:`~.FileIO.FileIO.load_MDAnalysis_into`
    ...
    def load_MDAnalysis_into_using_universe_object(self, universe):
        ...
        Wrapper function for
        :meth:`~.FileIO.FileIO.load_MDAnalysis_into_using_universe_object`
    ...
    def get_number_of_bond_partners_of_element(self, atom_index, the_element):
        ...
        Wrapper function for
        :meth:`~.AtomsAndBonds.AtomsAndBonds.get_number_of_bond_partners_of_element`
    ...
    def get_index_of_first_bond_partner_of_element(self, atom_index, the_element):
        ...
        Wrapper function for :meth:`~.AtomsAndBonds.AtomsAndBonds.get_index_of_first_bond_partner_of_element`
    ...
    def create_bonds_by_distance(
        ...
        Wrapper function for
        :meth:`~.AtomsAndBonds.AtomsAndBonds.create_bonds_by_distance`
    ...
    def delete_bond(self, index1, index2):
        ...
        Wrapper function for :meth:`~.AtomsAndBonds.AtomsAndBonds.delete_bond`
    ...
    def add_bond(self, index1, index2, order=1):
        ...
        Wrapper function for :meth:`~.AtomsAndBonds.AtomsAndBonds.add_bond`
    ...
    def delete_atom(self, index):
        ...
        Wrapper function for :meth:`~.AtomsAndBonds.AtomsAndBonds.delete_atom`
    ...
    def add_atom(
        ...
        Wrapper function for :meth:`~.AtomsAndBonds.AtomsAndBonds.add_atom`
    ...
    def get_molecule_from_selection(
        ...
        :returns: A .Molecule object containing the atoms of the
    ...
    def select_atoms(self, selection_criteria):
        ...
        Wrapper function for :meth:`~.Selections.Selections.select_atoms`
    ...
    def select_atoms_in_bounding_box(self, bounding_box):
        ...
        Wrapper function for :meth:`~.Selections.Selections.select_atoms_in_bounding_box`
    ...
    def select_branch(self, root_atom_index, directionality_atom_index):
        ...
        Wrapper function for :meth:`~.Selections.Selections.select_branch`
        ...
        return self.selections.select_branch(root_atom_index, directionality_atom_index)
    ...
    def select_all_atoms_bound_to_selection(self, selections):
        ...
        Wrapper function for :meth:`~.Selections.Selections.select_all_atoms_bound_to_selection`
    ...
    def select_atoms_from_same_molecule(self, selection):
        ...
        user-defined selection, assuming that the .Molecule object
        actually contains multiple physically distinct molecules that are not
        bound to each other via covalent bonds.

        Requires the :any:`numpy` library.

        Wrapper function for :meth:`~.Selections.Selections.select_atoms_from_same_molecule`
    ...
    def selections_of_constituent_molecules(self):
        ...
        assuming that the .Molecule object actually contains multiple
        physically distinct molecules that are not bound to each other via
        covalent bonds.

        Requires the :any:`numpy` library.

        Wrapper function for :meth:`~.Selections.Selections.selections_of_constituent_molecules`
    ...
    def select_atoms_near_other_selection(self, selection, cutoff):
        ...
        Wrapper function for :meth:`~.Selections.Selections.select_atoms_near_other_selection`
        ...
        return self.selections.select_atoms_near_other_selection(selection, cutoff)
    ...
    def select_atoms_in_same_residue(self, selection):
        ...
        Wrapper function for :meth:`~.Selections.Selections.select_atoms_in_same_residue`
    ...
    def invert_selection(self, selection):
        ...
        Wrapper function for :meth:`~.Selections.Selections.invert_selection`
    ...
    def select_all(self):
        ...
        Wrapper function for :meth:`~.Selections.Selections.select_all`
    ...
    def select_close_atoms_from_different_molecules(
        ...
        Wrapper function for :meth:`~.Selections.Selections.select_close_atoms_from_different_molecules`

        :param .Molecule other_mol: A .Molecule object of the other
                    molecule.
        ...
        :returns: A tuple containing two elements. The first is a numpy.array
                    ...
                    .Molecule object (self). The second is a
    ...
    def selections_of_chains(self):
        ...
        Wrapper function for :meth:`~.Selections.Selections.selections_of_chains`
    ...
    def selections_of_residues(self):
        ...
        Wrapper function for :meth:`~.Selections.Selections.selections_of_residues`
    ...
    def set_atom_location(self, atom_index, new_location):
        ...
        Wrapper function for :meth:`~.Manipulation.Manipulation.set_atom_location`
    ...
    def set_coordinate_undo_point(self):
        ...
        Wrapper function for :meth:`~.Manipulation.Manipulation.set_coordinate_undo_point`
        """
    ...
    def coordinate_undo(self):
        ...
        Wrapper function for :meth:`~.Manipulation.Manipulation.coordinate_undo`
        """
    ...
    def translate_molecule(self, delta):
        ...
        Wrapper function for :meth:`~.Manipulation.Manipulation.translate_molecule`
    ...
    def rotate_molecule_around_a_line_between_points(
        ...
        Wrapper function for :meth:`~.Manipulation.Manipulation.rotate_molecule_around_a_line_between_points`
    ...
    def rotate_molecule_around_a_line_between_atoms(
        ...
        Wrapper function for :meth:`~.Manipulation.Manipulation.rotate_molecule_around_a_line_between_atoms`
    ...
    def rotate_molecule_around_pivot_point(self, pivot, thetax, thetay, thetaz):
        ...
        Wrapper function for :meth:`~.Manipulation.Manipulation.rotate_molecule_around_pivot_point`
    ...
    def rotate_molecule_around_pivot_atom(self, pivot_index, thetax, thetay, thetaz):
        ...
        Wrapper function for :meth:`~.Manipulation.Manipulation.rotate_molecule_around_pivot_atom`
    ...
    def get_angle_between_three_points(self, pt1, pt2, pt3):
        ...
        Wrapper function for :meth:`~.Geometry.Geometry.get_angle_between_three_points`
    ...
    def get_dihedral_angle(self, pt1, pt2, pt3, pt4):
        ...
        Wrapper function for :meth:`~.Geometry.Geometry.get_dihedral_angle`
    ...
    def get_planarity_deviation(self, pt1, pt2, pt3, pt4):
        ...
        Wrapper function for :meth:`~.Geometry.Geometry.get_planarity_deviation`
    ...
    def is_planar(self, pt1, pt2, pt3, pt4, planarity_cutoff=0.2):
        ...
        Wrapper function for :meth:`~.Geometry.Geometry.is_planar`
    ...
    def get_other_molecules_aligned_to_this(self, other_mol, tethers):
        """
        Aligns a molecule to self (this .Molecule object) using a
        quaternion RMSD alignment.

        Requires the :any:`numpy` library.

        Wrapper function for :meth:`~.OtherMolecules.OtherMolecules.get_other_molecules_aligned_to_this`

        :param .Molecule other_mol: A .Molecule that is to be aligned to
                    this one.
    ...
    def get_distance_to_another_molecule(
        self, other_molecules, pairwise_comparison=True
    ):
        """
        ...
        Wrapper function for :meth:`~.OtherMolecules.OtherMolecules.get_distance_to_another_molecule`

        :param .Molecule other_molecules: a .Molecule, the other molecular
                    model.
        :param bool pairwise_comparison: An optional boolean, whether or not to
                    perform a simple pairwise distance comparison (if True) or
                    to use a more sophisitcated method (if False). True by
    ...
    def get_distance_to_another_molecules(
        self, other_molecules, pairwise_comparison=True
    ):
        """
        DEPRECATION WARNING: Please use :meth:`~.Molecule.Molecule.get_distance_to_another_molecule`
    ...
    def get_rmsd_equivalent_atoms_specified(self, other_mol, tethers):
        ...
        Wrapper function for :meth:`~.OtherMolecules.OtherMolecules.get_rmsd_equivalent_atoms_specified`

        :param .Molecule other_mol: The other .Molecule object.
        :param tuple tethers: A tuple of two numpy.array objects, where each array
                    contains the indices of self and other_mol, respectively,
                    such that equivalent atoms are listed in the same order.
                    So, for example, if (atom 1, self = atom 3, other) and
    ...
    def get_rmsd_order_dependent(self, other_mol):
        ...
        Wrapper function for :meth:`~.OtherMolecules.OtherMolecules.get_rmsd_order_dependent`
    ...
    def get_rmsd_heuristic(self, other_mol):
        ...
        Wrapper function for :meth:`~.OtherMolecules.OtherMolecules.get_rmsd_heuristic`
    ...
    def steric_clash_with_another_molecules(
        self, other_mol, cutoff, pairwise_comparison=True
    ):
        """
        DEPRECATION WARNING: Please use :meth:`~.Molecule.Molecule.steric_clash_with_another_molecule`
        Detects steric clashes between the .Molecule (self) and
        another .Molecule.

        Requires the :any:`numpy` and :any:`scipy<scipy.spatial>` libraries.

        Wrapper function for :meth:`~.OtherMolecules.OtherMolecules.steric_clash_with_another_molecule`

        :param .Molecule other_mol: The .Molecule object that will be
    ...
    def merge_with_another_molecules(self, other_molecules):
        """
        DEPRECATION WARNING: Please use :meth:`~.Molecule.Molecule.merge_with_another_molecule`
        Merges two molecular models into a single model.

        Wrapper function for :meth:`~.OtherMolecules.OtherMolecules.merge_with_another_molecule`

        :param .Molecule other_molecules: A molecular model (.Molecule
                    object).

        :returns: A single .Molecule object containing the atoms of
    ...
    def copy(self):
        """
        Returns an exact copy (.Molecule) of this Molecule object.
        Undo points are NOT copied.

        :returns: A .Molecule, containing to the same atomic
                    information as this .Molecule object.
        """
