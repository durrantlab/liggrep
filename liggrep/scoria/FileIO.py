...
class FileIO():
    """A class for saving and loading molecular data into a .Molecule
    object."""
    ...
    def load_pym_into(self, filename):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.load_pym_into`
    ...
    def load_pdbqt_trajectory_into_using_file_object(self, file_obj,
        ...
        :meth:`.Molecule.Molecule.load_pdbqt_trajectory_into_using_file_object`
    ...
    def load_pdbqt_into(self, filename, bonds_by_distance = False,
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.load_pdbqt_into`
    ...
    def load_pdbqt_into_using_file_object(self, file_obj,
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.load_pdbqt_into_using_file_object`
    ...
    def load_pdb_into(self, filename, bonds_by_distance = False,
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.load_pdb_into`
    ...
    def load_pdb_into_using_file_object(self, file_obj,
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.load_pdb_into_using_file_object`
    ...
    def save_pym(self, filename, save_bonds = False, save_filename = False,
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.save_pym`
    ...
    def save_pdb(self, filename = "", serial_reindex = True, resseq_reindex = False,
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.save_pdb`
    ...
    def _save_pdb_trajectory(self, filename = "", serial_reindex = True,
        ...
        """
        Saves the molecular trajectory data contained in a .Molecule
    ...
    def load_MDAnalysis_into(self, *args):
        ...
        ***Note this function is only functional in Scoria_MDA***
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.load_MDAnalysis_into`
