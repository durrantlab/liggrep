...
class OtherMolecules():
    ...
    def __init__(self, parent_molecule_object):
        """
        Initializes the .OtherMolecules class.
    ...
    def get_other_molecules_aligned_to_this(self, other_mol, tethers,
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.get_other_molecules_aligned_to_this`
    ...
    def steric_clash_with_another_molecule(self, other_mol, cutoff,
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.steric_clash_with_another_molecule`
    ...
    def merge_with_another_molecule(self, other_molecules):
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.merge_with_another_molecule`
    ...
    def get_distance_to_another_molecule(self, other_molecules,
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.get_distance_to_another_molecule`
    ...
    def get_rmsd_equivalent_atoms_specified(self, other_mol, tethers):
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.get_rmsd_equivalent_atoms_specified`
    ...
    def get_rmsd_order_dependent(self, other_mol):
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.get_rmsd_order_dependent`
    ...
    def get_rmsd_heuristic(self, other_mol):
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.get_rmsd_heuristic`
