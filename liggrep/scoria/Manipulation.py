...
class Manipulation():
    ...
    def __init__(self, parent_molecule_object):
        """
        Initializes the .Manipulation class.
    ...
    def set_atom_location(self, atom_index, new_location):
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.set_atom_location`
    ...
    def translate_molecule(self, delta):
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.translate_molecule`
    ...
    def rotate_molecule_around_a_line_between_points(self, line_point1,
        ...
        :meth:`~.Molecule.Molecule.rotate_molecule_around_a_line_between_points`
    ...
    def rotate_molecule_around_a_line_between_atoms(self, line_point1_index,
        ...
        Wrapper function for
        :meth:`~.Molecule.Molecule.rotate_molecule_around_a_line_between_atoms`
    ...
    def rotate_molecule_around_pivot_point(self, pivot, thetax,
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.rotate_molecule_around_pivot_point`
    ...
    def rotate_molecule_around_pivot_atom(self, pivot_index, thetax,
        ...
        Wrapper function for :meth:`~.Molecule.Molecule.rotate_molecule_around_pivot_atom`
