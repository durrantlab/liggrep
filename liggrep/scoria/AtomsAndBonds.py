...
class AtomsAndBonds():
    ...
    def __init__(self, parent_molecule_object):
        """
        Initializes the .AtomsAndBonds class.
    ...
    def create_bonds_by_distance(self, remove_old_bond_data = True,
        ...
        :meth:`~.Molecule.Molecule.create_bonds_by_distance`.
    ...
    def get_number_of_bond_partners_of_element(self, atom_index, the_element):
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.get_number_of_bond_partners_of_element`.
    ...
    def get_index_of_first_bond_partner_of_element(self, atom_index,
        ...
        Should be called via the wrapper function
        :meth:`~.Molecule.Molecule.get_index_of_first_bond_partner_of_element`.
    ...
    def delete_bond(self, index1, index2):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.delete_bond`.
    ...
    def add_bond(self, index1, index2, order = 1):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.add_bond`.
    ...
    def delete_atom(self, index):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.delete_atom`.
    ...
    def add_atom(self, record_name = "ATOM", serial = 1, name = "X",
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.add_atom`.
