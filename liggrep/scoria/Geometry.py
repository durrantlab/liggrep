...
class Geometry():
    ...
    def get_angle_between_three_points(self, pt1, pt2, pt3):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.get_angle_between_three_points`
    ...
    def get_dihedral_angle(self, pt1, pt2, pt3, pt4):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.get_dihedral_angle`
    ...
    def is_planar(self, pt1, pt2, pt3, pt4, planarity_cutoff = 0.2):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.is_planar`
    ...
    def get_planarity_deviation(self, pt1, pt2, pt3, pt4):
        ...
        Should be called via the wrapper function :meth:`~.Molecule.Molecule.get_planarity_deviation`
